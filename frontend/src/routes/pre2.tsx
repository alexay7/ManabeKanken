...
export const Route = createFileRoute('/pre2')({
  component: KankenPre2,
...
function KankenPre2() {
  ...
  return (
      <div className="flex flex-col gap-8 w-full md:px-[100px]">
        ...
        <h1 className="text-center">漢検準２級試験</h1>
        {/*    EJERCICIO 1*/}
        <ul className="flex flex-wrap flex-row-reverse gap-x-8 gap-y-12">
            ...
            <li className="flex flex-row-reverse gap-5 items-start">
                <div className="vertical-text h-[380px] flex flex-row leading-5 items-start text-sm">
                    ...
                    <p>{exerciseInfo["pre2"][0].statement}</p>
                    <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                        <p className="text-[8px]">({exerciseInfo["pre2"][0].total})</p>
                        <p className="text-[12px]">{exerciseInfo["pre2"][0].perQuestion}x{exerciseInfo["pre2"][0].questions}</p>
                    </div>
                </div>
                <div className="mt-2">
                    <ReadingExercise exercises={exam.filter(e=>e.type==="reading")} answers={answers} answerQuestion={answerQuestion} fontSize={exerciseInfo["pre2"][0].fontSize}/>
                </div>
            </li>
            )}
            ...
            <li className="flex flex-row-reverse gap-5 items-start">
                <div className="vertical-text h-[380px] flex flex-row leading-5 items-start text-sm">
                    ...
                    <p>{exerciseInfo["pre2"][1].statement}</p>
                    <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                        <p className="text-[8px]">({exerciseInfo["pre2"][1].total})</p>
                        <p className="text-[12px]">{exerciseInfo["pre2"][1].perQuestion}x{exerciseInfo["pre2"][1].questions}</p>
                    </div>
                </div>
                <div className="mt-2">
                    <WriteRadicalExercise exercises={exam.filter(e=>e.type==="writeradical")} answers={answers} answerQuestion={answerQuestion} fontSize={exerciseInfo["pre2"][1].fontSize}/>
                </div>
            </li>
            )}
            ...
            {exam.filter(e=>e.type==="multiplechoose").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["pre2"][2].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["pre2"][2].total})</p>
                            <p className="text-[12px]">{exerciseInfo["pre2"][2].perQuestion}x{exerciseInfo["pre2"][2].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <ChooseKanjiExercise exercises={exam.filter(e=>e.type==="multiplechoose")} answers={answers
                        } answerQuestion={answerQuestion} fontSize={exerciseInfo["pre2"][2].fontSize}/>
                    </div>
                </li>
            )}
            ...
            {exam.filter(e=>e.type==="kanjirelated").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["pre2"][3].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["pre2"][3].total})</p>
                            <p className="text-[12px]">{exerciseInfo["pre2"][3].perQuestion}x{exerciseInfo["pre2"][3].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <WriteKanjiExercise exercises={exam.filter(e=>e.type==="kanjirelated")} answers={answers
                        } answerQuestion={answerQuestion} fontSize={exerciseInfo["pre2"][3].fontSize}/>
                    </div>
                </li>
            )}
            ...
            {exam.filter(e=>e.type==="definitionschoose").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["pre2"][4].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["pre2"][4].total})</p>
                            <p className="text-[12px]">{exerciseInfo["pre2"][4].perQuestion}x{exerciseInfo["pre2"][4].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <ChooseKanjiExercise exercises={exam.filter(e=>e.type==="definitionschoose")} answers={answers
                        } answerQuestion={answerQuestion} fontSize={exerciseInfo["pre2"][4].fontSize}/>
                    </div>
                </li>
            )}
            ...
            {exam.filter(e=>e.type==="synonyms").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["pre2"][5].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["pre2"][5].total})</p>
                            <p className="text-[12px]">{exerciseInfo["pre2"][5].perQuestion}x{exerciseInfo["pre2"][5].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <WriteKanjiExercise exercises={exam.filter(e=>e.type==="synonyms")} answers={answers
                        } answerQuestion={answerQuestion} fontSize={exerciseInfo["pre2"][5].fontSize}/>
                    </div>
                </li>
            )}
            ...
            {exam.filter(e=>e.type==="groupwriting").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["pre2"][6].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["pre2"][6].total})</p>
                            <p className="text-[12px]">{exerciseInfo["pre2"][6].perQuestion}x{exerciseInfo["pre2"][6].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <GroupWritingExercise exercises={exam.filter(e=>e.type==="groupwriting")} answers={answers
                        } answerQuestion={answerQuestion} fontSize={exerciseInfo["pre2"][6].fontSize}/>
                    </div>
                </li>
            )}
            ...
            {exam.filter(e=>e.type==="wrongkanji").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["pre2"][7].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["pre2"][7].total})</p>
                            <p className="text-[12px]">{exerciseInfo["pre2"][7].perQuestion}x{exerciseInfo["pre2"][7].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <WrongKanjiExercise exercises={exam.filter(e=>e.type==="wrongkanji")} answers={answers
                        } answerQuestion={answerQuestion} fontSize={exerciseInfo["pre2"][7].fontSize}/>
                    </div>
                </li>
            )}
            ...
            {exam.filter(e=>e.type==="okurigana").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["pre2"][8].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["pre2"][8].total})</p>
                            <p className="text-[12px]">{exerciseInfo["pre2"][8].perQuestion}x{exerciseInfo["pre2"][8].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <WriteKanjiExercise exercises={exam.filter(e=>e.type==="okurigana")} answers={answers
                        } answerQuestion={answerQuestion} fontSize={exerciseInfo["pre2"][8].fontSize}/>
                    </div>
                </li>
            )}
            ...
            {exam.filter(e=>e.type==="textsquares").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[380px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["pre2"][9].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["pre2"][9].total})</p>
                            <p className="text-[12px]">{exerciseInfo["pre2"][9].perQuestion}x{exerciseInfo["pre2"][9].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <WriteKanjiExercise exercises={exam.filter(e=>e.type==="textsquares")} answers={answers
                        } answerQuestion={answerQuestion} fontSize={exerciseInfo["pre2"][9].fontSize}/>
                    </div>
                </li>
            )}
        </ul>
