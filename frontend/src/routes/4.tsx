...
function Kanken4() {
  ...
  return (
      <div className="flex flex-col gap-8 w-full md:px-[100px]">
        ...
        <h1 className="text-center">漢検４級試験</h1>
        {/*    EJERCICIO 1*/}
            ...
            {exam.filter(e=>e.type==="reading").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text h-[380px] flex flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["4"][0].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["4"][0].total})</p>
                            <p className="text-[12px]">{exerciseInfo["4"][0].perQuestion}x{exerciseInfo["4"][0].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <ReadingExercise exercises={exam.filter(e=>e.type==="reading")} answers={answers} answerQuestion={answerQuestion} fontSize={exerciseInfo["4"][0].fontSize}/>
                    </div>
                </li>
            )}

            {exam.filter(e=>e.type==="multiplechoosetext").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text h-[380px] flex flex-row leading-5 items-start text-sm">
                        <span className="border border-black w-max font-semibold mb-1">2</span>
                        <p>{exerciseInfo["4"][1].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["4"][1].total})</p>
                            <p className="text-[12px]">{exerciseInfo["4"][1].perQuestion}x{exerciseInfo["4"][1].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <ChooseKanjiExercise exercises={exam.filter(e=>e.type==="multiplechoosetext")} answers={answers} answerQuestion={answerQuestion} fontSize={exerciseInfo["4"][1].fontSize}/>
                    </div>
                </li>
            )}

            {exam.filter(e=>e.type==="commonkanji").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text h-[380px] flex flex-row leading-5 items-start text-sm">
                        <span className="border border-black w-max font-semibold mb-1">3</span>
                        <p>{exerciseInfo["4"][2].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["4"][2].total})</p>
                            <p className="text-[12px]">{exerciseInfo["4"][2].perQuestion}x{exerciseInfo["4"][2].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <ChooseKanjiExercise exercises={exam.filter(e=>e.type==="commonkanji")} answers={answers} answerQuestion={answerQuestion} fontSize={exerciseInfo["4"][2].fontSize}/>
                    </div>
                </li>
            )}
            ...
            {exam.filter(e=>e.type==="multiplechoose").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["4"][3].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["4"][3].total})</p>
                            <p className="text-[12px]">{exerciseInfo["4"][3].perQuestion}x{exerciseInfo["4"][3].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <ChooseKanjiExercise exercises={exam.filter(e=>e.type==="multiplechoose")} answers={answers
                        } answerQuestion={answerQuestion} fontSize={exerciseInfo["4"][3].fontSize}/>
                    </div>
                </li>
            )}
            ...
            {exam.filter(e=>e.type==="choose").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[380px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["4"][4].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["4"][4].total})</p>
                            <p className="text-[12px]">{exerciseInfo["4"][4].perQuestion}x{exerciseInfo["4"][4].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <ChooseExercise exercises={exam.filter(e=>e.type==="choose")} answers={answers} answerQuestion={answerQuestion} fontSize={exerciseInfo["4"][4].fontSize}/>
                    </div>
                </li>
            )}
            ...
            {exam.filter(e=>e.type==="synonyms").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["4"][5].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["4"][5].total})</p>
                            <p className="text-[12px]">{exerciseInfo["4"][5].perQuestion}x{exerciseInfo["4"][5].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <WriteKanjiExercise exercises={exam.filter(e=>e.type==="synonyms")} answers={answers
                        } answerQuestion={answerQuestion} fontSize={exerciseInfo["4"][5].fontSize}/>
                    </div>
                </li>
            )}
            ...
            {exam.filter(e=>e.type==="okurigana").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["4"][6].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["4"][6].total})</p>
                            <p className="text-[12px]">{exerciseInfo["4"][6].perQuestion}x{exerciseInfo["4"][6].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <WriteKanjiExercise exercises={exam.filter(e=>e.type==="okurigana")} answers={answers
                        } answerQuestion={answerQuestion} fontSize={exerciseInfo["4"][6].fontSize}/>
                    </div>
                </li>
            )}
            ...
            {exam.filter(e=>e.type==="kanjirelated").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["4"][7].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["4"][7].total})</p>
                            <p className="text-[12px]">{exerciseInfo["4"][7].perQuestion}x{exerciseInfo["4"][7].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <WriteKanjiExercise exercises={exam.filter(e=>e.type==="kanjirelated")} answers={answers
                        } answerQuestion={answerQuestion} fontSize={exerciseInfo["4"][7].fontSize}/>
                    </div>
                </li>
            )}
            ...
            {exam.filter(e=>e.type==="wrongkanji").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["4"][8].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["4"][8].total})</p>
                            <p className="text-[12px]">{exerciseInfo["4"][8].perQuestion}x{exerciseInfo["4"][8].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <WrongKanjiExercise exercises={exam.filter(e=>e.type==="wrongkanji")} answers={answers
                        } answerQuestion={answerQuestion} fontSize={exerciseInfo["4"][8].fontSize}/>
                    </div>
                </li>
            )}
            ...
            {exam.filter(e=>e.type==="textsquares").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[380px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["4"][9].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["4"][9].total})</p>
                            <p className="text-[12px]">{exerciseInfo["4"][9].perQuestion}x{exerciseInfo["4"][9].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <WriteKanjiExercise exercises={exam.filter(e=>e.type==="textsquares")} answers={answers
                        } answerQuestion={answerQuestion} fontSize={exerciseInfo["4"][9].fontSize}/>
                    </div>
                </li>
            )}
        </ul>
