...
function Kanken10() {
  ...
  return (
      <div className="flex flex-col gap-8 w-full md:px-[100px] select-none">
          <ExamResults answers={answers}/>

          <h1 className="text-center">漢検１０級試験</h1>
        {/*    EJERCICIO 1*/}
          <ul className="flex flex-wrap flex-row-reverse gap-x-8 gap-y-12">
              ...
              <li className="flex flex-row-reverse gap-5 items-start">
                  <div className="vertical-text h-[380px] flex flex-row leading-5 items-start text-sm">
                      ...
                      <p>{exerciseInfo["10"][0].statement}</p>
                      <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                          <p className="text-[8px]">({exerciseInfo["10"][0].total})</p>
                          <p className="text-[12px]">{exerciseInfo["10"][0].perQuestion}x{exerciseInfo["10"][0].questions}</p>
                      </div>
                  </div>
                  <div className="mt-2">
                      <ReadingExercise exercises={exam.filter(e=>e.type==="reading")} answers={answers} answerQuestion={answerQuestion} fontSize={exerciseInfo["10"][0].fontSize}/>
                  </div>
              </li>
              )}
              ...
              <li className="flex flex-row-reverse gap-5 items-start">
                  <div className="vertical-text flex h-[380px] flex-row leading-5 items-start text-sm">
                      ...
                      <p>{exerciseInfo["10"][1].statement}</p>
                      <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                          <p className="text-[8px]">({exerciseInfo["10"][1].total})</p>
                          <p className="text-[12px]">{exerciseInfo["10"][1].perQuestion}x{exerciseInfo["10"][1].questions}</p>
                      </div>
                  </div>
                  <div className="mt-2">
                      <StrokeOrderExercise exercises={exam.filter(e=>e.type==="strokeorder")} answers={answers} answerQuestion={answerQuestion} fontSize={exerciseInfo["10"][1].fontSize}/>
                  </div>
              </li>
              )}
              ...
              <li className="flex flex-row-reverse gap-5 items-start">
                  <div className="vertical-text h-[380px] flex flex-row leading-5 items-start text-sm">
                      ...
                      <p>{exerciseInfo["10"][2].statement}</p>
                      <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                          <p className="text-[8px]">({exerciseInfo["10"][2].total})</p>
                          <p className="text-[12px]">{exerciseInfo["10"][2].perQuestion}x{exerciseInfo["10"][2].questions}</p>
                      </div>
                  </div>
                  <div className="mt-2">
                      <GroupReadingExercise exercises={exam.filter(e=>e.type==="groupreading")} answers={answers} answerQuestion={answerQuestion} fontSize={exerciseInfo["10"][2].fontSize}/>
                  </div>
              </li>
                    )}
              ...
              <br/>
                ...
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[380px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["10"][3].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["10"][3].total})</p>
                            <p className="text-[12px]">{exerciseInfo["10"][3].perQuestion}x{exerciseInfo["10"][3].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                    <ChooseExercise exercises={exam.filter(e=>e.type==="choose")} answers={answers} answerQuestion={answerQuestion} fontSize={exerciseInfo["10"][3].fontSize}/>
                    </div>
                </li>
                    )}
              ...
              <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[380px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["10"][4].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["10"][4].total})</p>
                            <p className="text-[12px]">{exerciseInfo["10"][4].perQuestion}x{exerciseInfo["10"][4].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <WriteHiraganaExercise exercises={exam.filter(e=>e.type==="hiragana")} answers={answers
                        } answerQuestion={answerQuestion} fontSize={exerciseInfo["10"][4].fontSize}/>
                    </div>
                </li>
                    )}
              ...
              <li className="flex flex-row-reverse gap-5 items-start">
                  <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                      ...
                      <p>{exerciseInfo["10"][5].statement}</p>
                      <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                          <p className="text-[8px]">({exerciseInfo["10"][5].total})</p>
                          <p className="text-[12px]">{exerciseInfo["10"][5].perQuestion}x{exerciseInfo["10"][5].questions}</p>
                      </div>
                  </div>
                  <div className="mt-2">
                      <WriteKanjiExercise exercises={exam.filter(e=>e.type==="kanjirelated")} answers={answers
                      } answerQuestion={answerQuestion} fontSize={exerciseInfo["10"][5].fontSize}/>
                  </div>
              </li>
                    )}
              ...
              <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[380px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["10"][6].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["10"][6].total})</p>
                            <p className="text-[12px]">{exerciseInfo["10"][6].perQuestion}x{exerciseInfo["10"][6].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <WriteKanjiExercise exercises={exam.filter(e=>e.type==="textsquares")} answers={answers
                        } answerQuestion={answerQuestion} fontSize={exerciseInfo["10"][6].fontSize}/>
                    </div>
                </li>
                    )}
          </ul>
