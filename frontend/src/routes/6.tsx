...
import MultipleKanjiChooseeExercise from "@/components/MultipleKanjiChooseExercise.tsx";
...
function Kanken6() {
  ...
  return (
      <div className="flex flex-col gap-8 w-full md:px-[100px] px-14">
          <ExamResults answers={answers}/>

        <h1 className="text-center">漢検６級試験</h1>
        {/*    EJERCICIO 1*/}
        <ul className="flex flex-wrap flex-row-reverse gap-x-8 gap-y-12">
            {exam.filter(e=>e.type==="reading").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text h-[380px] flex flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["6"][0].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["6"][0].total})</p>
                            <p className="text-[12px]">{exerciseInfo["6"][0].perQuestion}x{exerciseInfo["6"][0].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <ReadingExercise exercises={exam.filter(e=>e.type==="reading")} answers={answers} answerQuestion={answerQuestion} fontSize={exerciseInfo["6"][0].fontSize}/>
                    </div>
                </li>
            )}
            ...
            {exam.filter(e=>e.type==="okurigana").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["6"][1].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["6"][1].total})</p>
                            <p className="text-[12px]">{exerciseInfo["6"][1].perQuestion}x{exerciseInfo["6"][1].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <WriteKanjiExercise exercises={exam.filter(e=>e.type==="okurigana")} answers={answers
                        } answerQuestion={answerQuestion} fontSize={exerciseInfo["6"][1].fontSize}/>
                    </div>
                </li>
            )}
            ...
            {exam.filter(e=>e.type==="components").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["6"][2].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["6"][2].total})</p>
                            <p className="text-[12px]">{exerciseInfo["6"][2].perQuestion}x{exerciseInfo["6"][2].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <ChooseKanjiExercise exercises={exam.filter(e=>e.type==="components")} answers={answers
                        } answerQuestion={answerQuestion} fontSize={exerciseInfo["6"][2].fontSize}/>
                    </div>
                </li>
            )}
            ...
            {exam.filter(e=>e.type==="strokeorder").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[380px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["6"][3].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["6"][3].total})</p>
                            <p className="text-[12px]">{exerciseInfo["6"][3].perQuestion}x{exerciseInfo["6"][3].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
            ...
            {exam.filter(e=>e.type==="multiplechoose").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["6"][4].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["6"][4].total})</p>
                            <p className="text-[12px]">{exerciseInfo["6"][4].perQuestion}x{exerciseInfo["6"][4].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <ChooseKanjiExercise exercises={exam.filter(e=>e.type==="multiplechoose")} answers={answers
                        } answerQuestion={answerQuestion} fontSize={exerciseInfo["6"][6].fontSize}/>
                    </div>
                </li>
            )}
            ...
            {exam.filter(e=>e.type==="completekanji").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["6"][5].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["6"][5].total})</p>
                            <p className="text-[12px]">{exerciseInfo["6"][5].perQuestion}x{exerciseInfo["6"][5].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
            ...
            {exam.filter(e=>e.type==="synonyms").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["6"][6].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["6"][6].total})</p>
                            <p className="text-[12px]">{exerciseInfo["6"][6].perQuestion}x{exerciseInfo["6"][6].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
            ...
            {exam.filter(e=>e.type==="multiplekanjichoose").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                        <span className="border border-black w-max font-semibold mb-1">8</span>
                        <p>{exerciseInfo["6"][7].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["6"][7].total})</p>
                            <p className="text-[12px]">{exerciseInfo["6"][7].perQuestion}x{exerciseInfo["6"][7].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <MultipleKanjiChooseeExercise exercises={exam.filter(e=>e.type==="multiplekanjichoose")} answers={answers
                        } answerQuestion={answerQuestion} fontSize={exerciseInfo["6"][7].fontSize}/>
                    </div>
                </li>
            )}
            ...
            {exam.filter(e=>e.type==="choose").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[380px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["6"][8].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["6"][8].total})</p>
                            <p className="text-[12px]">{exerciseInfo["6"][8].perQuestion}x{exerciseInfo["6"][8].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <ChooseExercise exercises={exam.filter(e=>e.type==="choose")} answers={answers} answerQuestion={answerQuestion} fontSize={exerciseInfo["6"][8].fontSize}/>
                    </div>
                </li>
            )}
            ...
            {exam.filter(e=>e.type==="groupwriting").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["6"][9].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["6"][9].total})</p>
                            <p className="text-[12px]">{exerciseInfo["6"][9].perQuestion}x{exerciseInfo["6"][9].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <GroupWritingExercise exercises={exam.filter(e=>e.type==="groupwriting")} answers={answers
                        } answerQuestion={answerQuestion} fontSize={exerciseInfo["6"][9].fontSize}/>
                    </div>
                </li>
            )}
            ...
            {exam.filter(e=>e.type==="textsquares").length>0 && (
                <li className="flex flex-row-reverse gap-5 items-start">
                    <div className="vertical-text flex h-[380px] flex-row leading-5 items-start text-sm">
                        ...
                        <p>{exerciseInfo["6"][10].statement}</p>
                        <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                            <p className="text-[8px]">({exerciseInfo["6"][10].total})</p>
                            <p className="text-[12px]">{exerciseInfo["6"][10].perQuestion}x{exerciseInfo["6"][10].questions}</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        <WriteKanjiExercise exercises={exam.filter(e=>e.type==="textsquares")} answers={answers
                        } answerQuestion={answerQuestion} fontSize={exerciseInfo["6"][10].fontSize}/>
                    </div>
                </li>
            )}
        </ul>
