...
import ChooseTextExercise from "@/components/ChooseTextExercise.tsx";
...
function Kanken7() {
    ...
    return (
        <div className="flex flex-col gap-8 w-full md:px-[100px]">
            ...
            <h1 className="text-center">漢検７級試験</h1>
            {/*    EJERCICIO 1*/}
            <ul className="flex flex-wrap flex-row-reverse gap-x-12 gap-y-12">
                {exam.filter(e=>e.type==="reading").length>0 && (
                    <li className="flex flex-row-reverse gap-5 items-start">
                        <div className="vertical-text h-[380px] flex flex-row leading-5 items-start text-sm">
                            ...
                            <p>{exerciseInfo["7"][0].statement}</p>
                            <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                                <p className="text-[8px]">({exerciseInfo["7"][0].total})</p>
                                <p className="text-[12px]">{exerciseInfo["7"][0].perQuestion}x{exerciseInfo["7"][0].questions}</p>
                            </div>
                        </div>
                        <div className="mt-2">
                            <ReadingExercise exercises={exam.filter(e=>e.type==="reading")} answers={answers} answerQuestion={answerQuestion} fontSize={exerciseInfo["7"][0].fontSize}/>
                        </div>
                    </li>
                )}
                ...
                {exam.filter(e=>e.type==="groupreading").length>0 && (
                    <li className="flex flex-row-reverse gap-5 items-start">
                        <div className="vertical-text h-[380px] flex flex-row leading-5 items-start text-sm">
                            ...
                            <p>{exerciseInfo["7"][1].statement}</p>
                            <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                                <p className="text-[8px]">({exerciseInfo["7"][1].total})</p>
                                <p className="text-[12px]">{exerciseInfo["7"][1].perQuestion}x{exerciseInfo["7"][1].questions}</p>
                            </div>
                        </div>
                        <div className="mt-2">
                            <GroupReadingExercise exercises={exam.filter(e=>e.type==="groupreading")} answers={answers} answerQuestion={answerQuestion} fontSize={exerciseInfo["7"][4].fontSize}/>
                        </div>
                    </li>
                )}

                {exam.filter(e=>e.type==="choosetext").length>0 && (
                    <li className="flex flex-row-reverse gap-5 items-start">
                        <div className="vertical-text h-[380px] flex flex-row leading-5 items-start text-sm">
                            <span className="border border-black w-max font-semibold mb-1">3</span>
                            <p>{exerciseInfo["7"][2].statement}</p>
                            <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                                <p className="text-[8px]">({exerciseInfo["7"][2].total})</p>
                                <p className="text-[12px]">{exerciseInfo["7"][2].perQuestion}x{exerciseInfo["7"][2].questions}</p>
                            </div>
                        </div>
                        <div className="mt-2">
                            <ChooseTextExercise exercises={exam.filter(e=>e.type==="choosetext")} answers={answers} answerQuestion={answerQuestion} fontSize={exerciseInfo["7"][1].fontSize}/>
                        </div>
                    </li>
                )}
                ...
                {exam.filter(e=>e.type==="strokeorder").length>0 && (
                    <li className="flex flex-row-reverse gap-5 items-start">
                        <div className="vertical-text flex h-[380px] flex-row leading-5 items-start text-sm">
                            ...
                            <p>{exerciseInfo["7"][3].statement}</p>
                            <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                                <p className="text-[8px]">({exerciseInfo["7"][3].total})</p>
                                <p className="text-[12px]">{exerciseInfo["7"][3].perQuestion}x{exerciseInfo["7"][3].questions}</p>
                            </div>
                        </div>
                        <div className="mt-2">
                            <StrokeOrderExercise exercises={exam.filter(e=>e.type==="strokeorder")} answers={answers} answerQuestion={answerQuestion} fontSize={exerciseInfo["7"][1].fontSize}/>
                        </div>
                    </li>
                )}
                ...
                {exam.filter(e=>e.type==="choose").length>0 && (
                    <li className="flex flex-row-reverse gap-5 items-start">
                        <div className="vertical-text flex h-[380px] flex-row leading-5 items-start text-sm">
                            ...
                            <p>{exerciseInfo["7"][4].statement}</p>
                            <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                                <p className="text-[8px]">({exerciseInfo["7"][4].total})</p>
                                <p className="text-[12px]">{exerciseInfo["7"][4].perQuestion}x{exerciseInfo["7"][4].questions}</p>
                            </div>
                        </div>
                        <div className="mt-2">
                            <ChooseExercise exercises={exam.filter(e=>e.type==="choose")} answers={answers} answerQuestion={answerQuestion} fontSize={exerciseInfo["7"][5].fontSize}/>
                        </div>
                    </li>
                )}

                {exam.filter(e=>e.type==="kanjirelatedgroup").length>0 && (
                    <li className="flex flex-row-reverse gap-5 items-start">
                        <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                            ...
                            <p>{exerciseInfo["7"][5].statement}</p>
                            <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                                <p className="text-[8px]">({exerciseInfo["7"][5].total})</p>
                                <p className="text-[12px]">{exerciseInfo["7"][5].perQuestion}x{exerciseInfo["7"][5].questions}</p>
                            </div>
                        </div>
                        <div className="mt-2">
                            <WriteKanjiExercise exercises={exam.filter(e=>e.type==="kanjirelatedgroup")} answers={answers
                            } answerQuestion={answerQuestion} fontSize={exerciseInfo["7"][5].fontSize}/>
                        </div>
                    </li>
                )}
                ...
                {exam.filter(e=>e.type==="okurigana").length>0 && (
                    <li className="flex flex-row-reverse gap-5 items-start">
                        <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                            ...
                            <p>{exerciseInfo["7"][6].statement}</p>
                            <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                                <p className="text-[8px]">({exerciseInfo["7"][6].total})</p>
                                <p className="text-[12px]">{exerciseInfo["7"][6].perQuestion}x{exerciseInfo["7"][6].questions}</p>
                            </div>
                        </div>
                        <div className="mt-2">
                            <WriteKanjiExercise exercises={exam.filter(e=>e.type==="okurigana")} answers={answers
                            } answerQuestion={answerQuestion} fontSize={exerciseInfo["7"][6].fontSize}/>
                        </div>
                    </li>
                )}
                ...
                {exam.filter(e=>e.type==="kanjicomponents").length>0 && (
                    <li className="flex flex-row-reverse gap-5 items-start">
                        <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                            ...
                            <p>{exerciseInfo["7"][7].statement}</p>
                            <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                                <p className="text-[8px]">({exerciseInfo["7"][7].total})</p>
                                <p className="text-[12px]">{exerciseInfo["7"][7].perQuestion}x{exerciseInfo["7"][7].questions}</p>
                            </div>
                        </div>
                        <div className="mt-2">
                            <WriteKanjiExercise exercises={exam.filter(e=>e.type==="kanjicomponents")} answers={answers
                            } answerQuestion={answerQuestion} fontSize={exerciseInfo["7"][7].fontSize}/>
                        </div>
                    </li>
                )}
                ...
                {exam.filter(e=>e.type==="groupwriting").length>0 && (
                    <li className="flex flex-row-reverse gap-5 items-start">
                        <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                            ...
                            <p>{exerciseInfo["7"][8].statement}</p>
                            <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                                <p className="text-[8px]">({exerciseInfo["7"][8].total})</p>
                                <p className="text-[12px]">{exerciseInfo["7"][8].perQuestion}x{exerciseInfo["7"][8].questions}</p>
                            </div>
                        </div>
                        <div className="mt-2">
                            <GroupWritingExercise exercises={exam.filter(e=>e.type==="groupwriting")} answers={answers
                            } answerQuestion={answerQuestion} fontSize={exerciseInfo["7"][8].fontSize}/>
                        </div>
                    </li>
                )}
                ...
                {exam.filter(e=>e.type==="multiplechoose").length>0 && (
                    <li className="flex flex-row-reverse gap-5 items-start">
                        <div className="vertical-text flex h-[450px] flex-row leading-5 items-start text-sm">
                            ...
                            <p>{exerciseInfo["7"][9].statement}</p>
                            <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                                <p className="text-[8px]">({exerciseInfo["7"][9].total})</p>
                                <p className="text-[12px]">{exerciseInfo["7"][9].perQuestion}x{exerciseInfo["7"][9].questions}</p>
                            </div>
                        </div>
                        <div className="mt-2">
                            <ChooseKanjiExercise exercises={exam.filter(e=>e.type==="multiplechoose")} answers={answers
                            } answerQuestion={answerQuestion} fontSize={exerciseInfo["7"][9].fontSize}/>
                        </div>
                    </li>
                )}
                ...
                {exam.filter(e=>e.type==="textsquares").length>0 && (
                    <li className="flex flex-row-reverse gap-5 items-start">
                        <div className="vertical-text flex h-[380px] flex-row leading-5 items-start text-sm">
                            ...
                            <p>{exerciseInfo["7"][10].statement}</p>
                            <div className="flex flex-col text-center font-semibold" style={{writingMode:"horizontal-tb"}}>
                                <p className="text-[8px]">({exerciseInfo["7"][10].total})</p>
                                <p className="text-[12px]">{exerciseInfo["7"][10].perQuestion}x{exerciseInfo["7"][10].questions}</p>
                            </div>
                        </div>
                        <div className="mt-2">
                            <WriteKanjiExercise exercises={exam.filter(e=>e.type==="textsquares")} answers={answers
                            } answerQuestion={answerQuestion} fontSize={exerciseInfo["7"][10].fontSize}/>
                        </div>
                    </li>
                )}
            </ul>
